...
<div class="Card-number">
        <ul>
          <li id="first-li"> <?php if($cardactivo == 'EUROPE'){echo "$cardnomeur";} else {echo "$cardnomint";} ?> </li>
          <li></li>
          <li></li>
          <li id="last-li"></li>
        </ul>
...
<?php
  if($cardactivo == 'EUROPE'){
    echo "Ultima vez internacional:";
    echo "$ultvezint";
  }
  else {
    echo "Ultima vez europa:";
    echo "$ultvezeur";
  }
  ?>
<br>
...
<div align="center">
  <form name="cambiarEUR" method="post" action="#">
    <input type="submit" name="cambiarEUR" value="Cambiar"/>
  </form>
</div>

<?php if(isset($_POST['cambiarEUR'])) {
    if($cardactivo == 'EUROPE') {
